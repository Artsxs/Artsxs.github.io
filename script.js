...
const codigosPromocionais = {
  ...
  "Update4.1": {
    pontos: 12500,
    mensagem: "Código Update4.1 resgatado! Você ganhou 12.500 pontos."
  },
  "Update4.2": {
    pontos: 15000,
    mensagem: "Código Update4.2 resgatado! Você ganhou 15.000 pontos."
  },
  "Update5.0": {
    pontos: 25000,
    tickets: { t1: 5, t10: 1, t100: 0 },
    mensagem: "Código Update5.0 resgatado! Você ganhou 25.000 pontos, 5 Tickets 1x e 1 Ticket 10x."
  },
  "Update5.1": {
    pontos: 35000,
    tickets: { t1: 0, t10: 2, t100: 0 },
    mensagem: "Código Update5.1 resgatado! Você ganhou 35.000 pontos e 2 Tickets 10x."
  },
  "Update5.2": {
    pontos: 50000,
    tickets: { t1: 0, t10: 3, t100: 0 },
    mensagem: "Código Update5.2 resgatado! Você ganhou 50.000 pontos e 3 Tickets 10x."
  },
  "Update5.3": {
    pontos: 75000,
    tickets: { t1: 0, t10: 0, t100: 1 },
    mensagem: "Código Update5.3 resgatado! Você ganhou 75.000 pontos e 1 Ticket 100x."
  },
  "Update5.4": {
    pontos: 100000,
    tickets: { t1: 0, t10: 0, t100: 2 },
    mensagem: "Código Update5.4 resgatado! Você ganhou 100.000 pontos e 2 Tickets 100x."
  },
  "Update5.5": {
    pontos: 125000,
    tickets: { t1: 0, t10: 0, t100: 3 },
    mensagem: "Código Update5.5 resgatado! Você ganhou 125.000 pontos e 3 Tickets 100x."
  },
  "Update5.6": {
    pontos: 150000,
    tickets: { t1: 0, t10: 0, t100: 5 },
    mensagem: "Código Update5.6 resgatado! Você ganhou 150.000 pontos e 5 Tickets 100x."
  },
  "Update5.7": {
    pontos: 200000,
    tickets: { t1: 0, t10: 0, t100: 5 },
    mensagem: "Código Update5.7 resgatado! Você ganhou 200.000 pontos e 5 Tickets 100x."
  },
  "Update5.8": {
    pontos: 300000,
    tickets: { t1: 0, t10: 0, t100: 10 },
    mensagem: "Código Update5.8 resgatado! Você ganhou 300.000 pontos e 10 Tickets 100x."
  },
  "Update5.9": {
    pontos: 500000,
    tickets: { t1: 0, t10: 0, t100: 15 },
    mensagem: "Código Update5.9 resgatado! Você ganhou 500K pontos e 15 Tickets 100x."
  },
  "Update5.10": {
    pontos: 750000,
    tickets: { t1: 0, t10: 0, t100: 20 },
    mensagem: "Código Update5.10 resgatado! Você ganhou 750K pontos e 20 Tickets 100x."
  },
  "Update5.11": {
    pontos: 1000000,
    tickets: { t1: 0, t10: 0, t100: 25 },
    mensagem: "Código Update5.11 resgatado! Você ganhou 1M pontos e 25 Tickets 100x."
  },
  "Update5.12": {
    pontos: 1500000,
    tickets: { t1: 0, t10: 0, t100: 30 },
    mensagem: "Código Update5.12 resgatado! Você ganhou 1,5M pontos e 30 Tickets 100x."
  },
  "Update5.13": {
    pontos: 2000000,
    tickets: { t1: 0, t10: 0, t100: 40 },
    mensagem: "Código Update5.13 resgatado! Você ganhou 2M pontos e 40 Tickets 100x."
  },
  "Update5.14": {
    pontos: 3000000,
    tickets: { t1: 0, t10: 0, t100: 50 },
    mensagem: "Código Update5.14 resgatado! Você ganhou 3M pontos e 50 Tickets 100x."
  },
  "Update5.15": {
    pontos: 5000000,
    tickets: { t1: 0, t10: 0, t100: 75 },
    mensagem: "Código Update5.15 resgatado! Você ganhou 5M pontos e 75 Tickets 100x."
  }
};
...
function calcularMultiplicadorEventoPontos() {
  let multiplicador = 1 + obterAuraEquipada().bonusPontos + obterPetEquipado().bonusPontos;
...
function sortearPersonagemDoMundo(mundo) {
  ...
  const bonusSorteBase = 1 + jogo.sorte * 0.05 + obterAuraEquipada().bonusLuck + obterPetEquipado().bonusLuck;
...
function calcularRecompensaBoss() {
  ...
  recompensa *= 1 + jogo.loja.bonusBoss * 0.25 + obterPetEquipado().bonusBoss;
...
function normalizarCodigo(codigo) {
  ...
  const aliasesCodigos = {
    ...
    Update58: "Update5.8",
    Update59: "Update5.9",
    Update510: "Update5.10",
    Update511: "Update5.11",
    Update512: "Update5.12",
    Update513: "Update5.13",
    Update514: "Update5.14",
    Update515: "Update5.15"
  };
